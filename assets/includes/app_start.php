...
if( ISSET( $_GET['theme'] ) && in_array($_GET['theme'], ['default', 'sunshine', 'freundeio'])){
    $_SESSION['theme'] = $_GET['theme'];
}

if( ISSET( $_SESSION['theme'] ) ){
    $config['theme'] = $_SESSION['theme'];
    if( $_SERVER["REQUEST_URI"] == "/v2/wonderful" || $_SERVER["REQUEST_URI"] == "/v2/freundeio" ){
...
$theme_settings['theme'] = 'freundeio';
