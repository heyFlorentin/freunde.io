...
(1, 'siteName', 'Freunde.io'),
(2, 'siteTitle', 'Freunde.io'),
(3, 'siteKeywords', 'social, freundeio, social site'),
(4, 'siteDesc', 'Freunde.io v1.5.6.2 is a Social Networking Platform. With our new feature, user can wonder posts, photos,'),
...
(88, 'free_to_login', '', 'You&#039;r free to &lt;a href=&quot;{site_url}&quot;&gt;{login}&lt;/a&gt; !', 'يمكنك الآن &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Je kan &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Votre libre &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Bitte hier &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Siete liberi di  &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Fa&amp;ccedil;a &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Вы&#039;r войти &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Eres libre de &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; !', 'Sen serbestsin &lt;a href=&quot;http://localhost/freundeio_update&quot;&gt;{login}&lt;/a&gt; ! için'),
...
(110, 'smooth_links_info', '', 'Enable smooth links, e.g.{site_url}/home.', 'لإستخدام الروابط القصيرة, مثال: http://localhost/freundeio_update/home.', 'Enable smooth links, e.g.http://localhost/freundeio_update/home.', 'Activer les liens lisses, e.g.http://localhost/freundeio_update/home.', 'Aktiviere Einfache Links, z.B.http://localhost/freundeio_update/start', 'Abilita collegamenti regolari, e.g.http://localhost/freundeio_update/home.', 'Ativar links limpos, exemplo.http://localhost/freundeio_update/home.', 'Включить гладкие ссылки, напримерhttp://localhost/freundeio_update/home.', 'Habilitar smooth links, e.g.http://localhost/freundeio_update/home.', 'Pürüzsüz bağlantıları etkinleştirme, e.g.http://localhost/freundeio_update/home.'),
(111, 'seo_frindly_info', '', 'Enable SEO friendly url, e.g.{site_url}//1_hello-how-are-you-doing.html', 'لإستخدام الروابط المساعدة لمواقع البحث, مثال: http://localhost/freundeio_update/1_hello-how-are-you-doing.html', 'Enable SEO friendly url, e.g.http://localhost/freundeio_update//1_hello-how-are-you-doing.html', 'Activer SEO URL conviviale, e.g.http://localhost/freundeio_update//1_hello-how-are-you-doing.html', 'Aktiviere SEO freundliche URL, z.B.http://localhost/freundeio_update//1_hallo-was-machst-du-gerade.html', 'Abilita SEO friendly url, e.g.http://localhost/freundeio_update//1_hello-how-are-you-doing.html', 'Ativar SEO URL, exemplo.http://localhost/freundeio_update//1_hello-how-are-you-doing.html', 'Включить SEO Дружественные ссылки, напримерhttp://localhost/freundeio_update//1_hello-how-are-you-doing.html', 'Habilitar url amigable para SEO, e.g.http://localhost/freundeio_update//1_hello-how-are-you-doing.html', 'SEO dostu url etkinleştirme, e.g.http://localhost/freundeio_update//1_hello-how-are-you-doing.html'),
...
(422, 'welcome_find_more_text', '', 'Find more of what you&#039;re looking for with Freunde.io Search.', 'أبحث عن ما تريد مع  نظام بحث واواندر', 'Vind meer van wat je zoekt met Freunde.io Search.', 'Trouver plus de ce que vous n &#39;êtes à la recherche d&#39;avec Freunde.io Recherche.', 'Finde viel mehr, was Du mit wen-kennt-wer-Suche suchst.', 'Trova più di quello che stai cercando con Freunde.io Ricerca.', 'Veja mais do que voc&amp;ecirc; esta procurando com o Freunde.io Search.', 'Узнайте больше о том, что вы ищете с помощью функции поиска Pintter.', 'Encuentras más de lo que estás buscando con el nuevo Pintter Buscador.', 'Eğer Freunde.io Arama ile aradığınızı daha bulun.'),
...
(445, 'site_keywords_help', '', 'Example: social, freundeio, social site', 'Example: social, freundeio, social site', 'Example: social, freundeio, social site', 'Example: social, freundeio, social site', 'Beispiel: soziale, wen-kennt-wer, soziale Website', 'Esempio: sociale, freundeio, sito di social', 'Exemplo: social, freundeio, site social', 'Пример: социальная сеть, pintter, социальный сайт', 'Ejemplo:, freundeio, sitio social sociales', 'Örnek: Sosyal, freundeio, sosyal sitesi'),
...
(666, 'discover_pro_types', '', 'Discover more features with {sitename} PRO packages !', 'اكتشاف المزيد للمحترفين من الميزات مع حزم {sitename}', 'Ontdek meer opties met {sitename} PRO!', 'Découvrez plus de fonctionnalités avec {sitename} PRO !', 'Entdecke mehr Funktionen mit dem {sitename} Pro-Paket !', 'Scopri di più caratteristiche con Freunde.io pacchetti PRO !', 'Descubra mais recursos com Freunde.io PRO packages !', 'Откройте для себя больше возможностей с Freunde.io пакетами PRO !', 'Descubre mas {sitename} funciones con los nuevos paquetes!', '{sitename} PRO paketleri ile daha fazla özellik keşfedin !'),
